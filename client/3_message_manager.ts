...
import { assertMessageType, ChatAction, constructMessage as constructMessage_, constructMiniAppInfo, constructVoiceTranscription, deserializeFileId, deserializeInlineMessageId, FileId, FileSource, FileType, ID, InputMedia, isMessageType, Message, MessageEntity, messageEntityToTlObject, ParseMode, PollOption, PriceTag, Reaction, reactionEqual, reactionToTlObject, replyMarkupToTlObject, SelfDestructOption, selfDestructOptionToInt, Update, UsernameResolver, VoiceTranscription } from "../3_types.ts";
