...
export class Client<C extends Context = Context> extends Composer<C> {
   ...
   * @method ms
   */
  async getSavedChats(params?: GetSavedMessagesParams): Promise<SavedChats> {
