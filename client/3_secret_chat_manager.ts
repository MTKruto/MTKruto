...
import type { EndSecretChatParams, SendSecretContactParams, SendSecretDocumentParams, SendSecretLocationParams, SendSecretMessageParams, SendSecretPhotoParams, SendSecretVenueParams, SendSecretVideoNoteParams, SendSecretVideoParams } from "./0_params.ts";
...
export class SecretChatManager implements UpdateProcessor<SecretChatManagerUpdate, true> {
  ...
  async sendSecretVideoNote(id: number, video: FileSource, params?: SendSecretVideoNoteParams) {
