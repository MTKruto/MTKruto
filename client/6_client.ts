...
export class Client<C extends Context = Context> extends Composer<C> implements ClientGeneric {
  ...
  async #importAuthorization(client: ClientEncrypted) {
    ...
    const exportedAuthorization = await this.#client!.invoke({ _: "auth.exportAuthorization", dc_id: getRawDcId(client.dc) });
  ...
  async addMusicToProfile(fileId: string, params?: AddMusicToProfileParams): Promise<void> {
    return await this.#accountManager.addMusicToProfile(fileId, params);
  }
  ...
  async addSavedNotificationSound(sound: FileSource, params?: AddSavedNotificationSoundParams): Promise<void> {
    return await this.#accountManager.addSavedNotificationSound(sound, params);
  }
  ...
  async getPrivacySetting(key: PrivacySettingKey): Promise<PrivacyRule[]> {
    return await this.#accountManager.getPrivacySetting(key);
  }
  ...
  async getProfileMusic(userId: ID, params?: GetProfileMusicParams): Promise<Audio[]> {
    return await this.#accountManager.getProfileMusic(userId, params);
  }
  ...
  async getSavedNotificationSounds(): Promise<SavedNotificationSound[]> {
    return await this.#accountManager.getSavedNotificationSounds();
  }
  ...
  async removeBusinessGreetingMessage(): Promise<void> {
    return await this.#accountManager.removeBusinessGreetingMessage();
  }
  ...
  async removeMusicFromProfile(fileId: string): Promise<void> {
    return await this.#accountManager.removeMusicFromProfile(fileId);
  }
  ...
  async removeSavedNotificationSound(fileId: string): Promise<void> {
    return await this.#accountManager.removeSavedNotificationSound(fileId);
  }
  ...
  async setBusinessAwayMessage(shortcutId: number, schedule: BusinessAwayMessageSchedule, recipients: InputBusinessRecipients, params?: SetBusinessAwayMessageParams): Promise<void> {
    await this.#accountManager.setBusinessAwayMessage(shortcutId, schedule, recipients, params);
  }
  ...
  async setBusinessGreetingMessage(shortcutId: number, recipients: InputBusinessRecipients, inactivityDayCount: number): Promise<void> {
    return await this.#accountManager.setBusinessGreetingMessage(shortcutId, recipients, inactivityDayCount);
  }
  ...
  async setPrivacySetting(key: PrivacySettingKey, rules: InputPrivacyRule[]): Promise<PrivacyRule[]> {
    return await this.#accountManager.setPrivacySetting(key, rules);
  }
  ...
  async deleteEphemeralMessage(chatId: ID, receiverUserId: ID, messageId: number): Promise<void> {
    return await this.#messageManager.deleteEphemeralMessage(chatId, receiverUserId, messageId);
  }
  ...
  async editEphemeralMessageCaption(chatId: ID, receiverUserId: ID, messageId: number, params?: EditMessageCaptionParams): Promise<Message> {
    return await this.#messageManager.editEphemeralMessageCaption(chatId, receiverUserId, messageId, params);
  }
  ...
  async editEphemeralMessageMedia(chatId: ID, receiverUserId: ID, messageId: number, media: InputMedia, params?: EditMessageMediaParams): Promise<Message> {
    return await this.#messageManager.editEphemeralMessageMedia(chatId, receiverUserId, messageId, media, params);
  }
  ...
  async editEphemeralMessageReplyMarkup(chatId: ID, receiverUserId: ID, messageId: number, params?: EditMessageReplyMarkupParams): Promise<Message> {
    return await this.#messageManager.editEphemeralMessageReplyMarkup(chatId, receiverUserId, messageId, params);
  }
  ...
  async editEphemeralMessageText(chatId: ID, receiverUserId: ID, messageId: number, text: string, params?: EditMessageTextParams): Promise<MessageText> {
    return await this.#messageManager.editEphemeralMessageText(chatId, receiverUserId, messageId, text, params);
  }
  ...
  async reportEphemeralMessage(chatId: ID, messageId: number, params?: ReportEphemeralMessageParams): Promise<ReportResult> {
    return await this.#messageManager.reportEphemeralMessage(chatId, messageId, params);
  }
  ...
  async saveDraft(chatId: ID, text: string, params?: SaveDraftParams): Promise<void> {
    return await this.#messageManager.saveDraft(chatId, text, params);
  }
  ...
  async saveRichTextDraft(chatId: ID, richText: InputRichText, params?: SaveRichTextDraftParams): Promise<void> {
    return await this.#messageManager.saveRichTextDraft(chatId, richText, params);
  }
  ...
  async downloadChunk(fileId: string, params?: DownloadParams): Promise<Uint8Array> {
    ...
    if (chunks.length) {
      const size = Math.min(length, chunkSize);
      if (chunks.length === 1 && chunks[0].byteLength === size) {
        return chunks[0];
      }
      const result = new Uint8Array(size);
      let offset = 0;
      for (const chunk of chunks) {
        const bytes = chunk.subarray(0, size - offset);
  ...
  async getNotificationSettings(chatId: ID): Promise<NotificationSettings> {
    return await this.#chatManager.getNotificationSettings(chatId);
  }
  ...
  async joinChat(chatId: ID): Promise<ChatJoinResult> {
    return await this.#chatManager.joinChat(chatId);
  }
  ...
  async joinChatByInviteLink(inviteLink: string): Promise<ChatJoinResult> {
    return await this.#chatManager.joinChatByInviteLink(inviteLink);
  }
  ...
  async setNotificationSettings(chatId: ID, params?: SetNotificationSettingsParams): Promise<void> {
    return await this.#chatManager.setNotificationSettings(chatId, params);
  }
  ...
  async deleteMyCommands(params?: DeleteMyCommandsParams): Promise<void> {
    return await this.#botInfoManager.deleteMyCommands(params);
  }
  ...
  async editStory(chatId: ID, storyId: number, params?: EditStoryParams): Promise<Story> {
    return await this.#storyManager.editStory(chatId, storyId, params);
  }
  ...
  async getStoriesInAlbum(chatId: ID, albumId: number, params?: GetStoriesInAlbumParams): Promise<AlbumStoryList> {
    return await this.#storyAlbumManager.getStoriesInAlbum(chatId, albumId, params);
  }
  ...
  async getTonTransactions(chatId: ID, params?: GetTonTransactionsParams): Promise<TonTransactionList> {
    return await this.#paymentManager.getTonTransactions(chatId, params);
  }
  ...
  async transferGift(chatId: ID, gift: InputGift, params?: TransferGiftParams): Promise<void> {
    return await this.#giftManager.transferGift(chatId, gift, params);
  }
  ...
  async setStickerSetThumbnail(slug: string, thumbnail: FileSource, params?: SetStickerSetThumbnailParams): Promise<void> {
    return await this.#stickerSetManager.setStickerSetThumbnail(slug, thumbnail, params);
  }
  ...
  async getCommunityP(communityId: number): Promise<CommunityP> {
    return await this.#communityManager.getCommunityP(communityId);
  }
