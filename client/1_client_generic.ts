...
export abstract class ClientGeneric {
   ...
   * @param text The message's text.
   */
  abstract sendSecretMessage(id: number, text: string, params?: SendSecretChatMessageParams): Promise<void>;
}
