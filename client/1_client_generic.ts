...
export abstract class ClientGeneric {
   ...
   */
  abstract signUp(firstName: string, params?: SignUpParams): Promise<number>;
   ...
   */
  abstract addMusicToProfile(fileId: string, params?: AddMusicToProfileParams): Promise<void>;
   ...
   */
  abstract addSavedNotificationSound(sound: FileSource, params?: AddSavedNotificationSoundParams): Promise<void>;
   ...
   */
  abstract getGiftPrivacy(): Promise<GiftPrivacy>;
   ...
   * @method ac
   */
  abstract getPrivacySetting(key: PrivacySettingKey): Promise<PrivacyRule[]>;
   ...
   */
  abstract getProfileMusic(userId: ID, params?: GetProfileMusicParams): Promise<Audio[]>;
   ...
   * @method ac
   */
  abstract getSavedNotificationSounds(): Promise<SavedNotificationSound[]>;
   ...
   * @method ac
   */
  abstract removeBusinessIntro(): Promise<void>;
   ...
   */
  abstract removeSavedNotificationSound(fileId: string): Promise<void>;
   ...
   */
  abstract setBusinessIntro(title: string, description: string, params?: SetBusinessIntroParams): Promise<void>;
   ...
   */
  abstract setGiftPrivacy(value: GiftPrivacy): Promise<void>;
   ...
   */
  abstract setNewChatPrivacy(value: NewChatPrivacy): Promise<void>;
   ...
   * @method ac
   */
  abstract setPrivacySetting(key: PrivacySettingKey, rules: InputPrivacyRule[]): Promise<PrivacyRule[]>;
   ...
   */
  abstract saveDraft(chatId: ID, text: string, params?: SaveDraftParams): Promise<void>;
   ...
   * @param text The text of the draft.
   */
  abstract saveRichTextDraft(chatId: ID, richText: InputRichText, params?: SaveRichTextDraftParams): Promise<void>;
   ...
   */
  abstract sendChatAction(chatId: ID, action: ChatActionType, params?: SendChatActionParams): Promise<void>;
   ...
   * @param chatId The identifier of the chat.
   */
  abstract getNotificationSettings(chatId: ID): Promise<NotificationSettings>;
   ...
   * @param chatId The identifier of the chat.
   */
  abstract setNotificationSettings(chatId: ID, params?: SetNotificationSettingsParams): Promise<void>;
   ...
   * @method bo
   */
  abstract deleteMyCommands(params?: DeleteMyCommandsParams): Promise<void>;
   ...
   */
  abstract getMyDescription(params?: GetMyDescriptionParams): Promise<string>;
   ...
   */
  abstract getMyName(params?: GetMyNameParams): Promise<string>;
   ...
   */
  abstract getMyShortDescription(params?: GetMyShortDescriptionParams): Promise<string>;
   ...
   * @method bo
   */
  abstract setMyDescription(params?: SetMyDescriptionParams): Promise<void>;
   ...
   * @method bo
   */
  abstract setMyName(params?: SetMyNameParams): Promise<void>;
   ...
   * @method bo
   */
  abstract setMyShortDescription(params?: SetMyShortDescriptionParams): Promise<void>;
   ...
   */
  abstract editStory(chatId: ID, storyId: number, params?: EditStoryParams): Promise<Story>;
   ...
   * @param albumId The identifier of an album.
   */
  abstract getStoriesInAlbum(chatId: ID, albumId: number, params?: GetStoriesInAlbumParams): Promise<AlbumStoryList>;
   ...
   */
  abstract getTonTransactions(chatId: ID, params?: GetTonTransactionsParams): Promise<TonTransactionList>;
   ...
   */
  abstract replaceStickerEmoji(fileId: string, emoji: string): Promise<void>;
   ...
   */
  abstract setStickerSetThumbnail(slug: string, thumbnail: FileSource, params?: SetStickerSetThumbnailParams): Promise<void>;
   ...
   * @param phoneNumber The contact's phone number.
   */
  abstract sendSecretContact(id: number, firstName: string, phoneNumber: string, params?: SendSecretContactParams): Promise<void>;
   ...
   */
  abstract createCommunity(name: string, chatId: ID, params?: CreateCommunityParams): Promise<Community>;
