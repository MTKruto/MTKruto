...
export abstract class ClientGeneric {
   ...
   * @param messageId The identifier of the message.
   */
  abstract reportEphemeralMessage(chatId: ID, messageId: number, params?: ReportEphemeralMessageParams): Promise<ReportResult>;
   ...
   */
  abstract reportStories(chatId: ID, storyIds: number[], params?: ReportStoryParams): Promise<ReportResult>;
   ...
   */
  abstract reportStory(chatId: ID, storyId: number, params?: ReportStoryParams): Promise<ReportResult>;
   ...
   */
  abstract transferGift(chatId: ID, gift: InputGift, params?: TransferGiftParams): Promise<void>;
   ...
   */
  abstract createCommunity(name: string, chatId: ID, params?: CreateCommunityParams): Promise<CommunityP>;
   ...
   * @param communityId The identifier of the community.
   */
  abstract getCommunityP(communityId: number): Promise<CommunityP>;
   ...
   * @method ct
   */
  abstract getJoinedCommunities(): Promise<CommunityP[]>;
