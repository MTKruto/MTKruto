...
export abstract class ClientGeneric {
   ...
   */
  abstract getRecommendedChannels(): Promise<ChannelList>;
   ...
   */
  abstract getSimilarChannels(chatId: ID): Promise<ChannelList>;
   ...
   */
  abstract getSimilarBots(chatId: ID): Promise<BotList>;
