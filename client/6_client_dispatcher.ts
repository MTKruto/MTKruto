...
export class ClientDispatcher<C extends Context = Context> extends Composer<C> implements ClientGeneric {
  ...
  async getLeftChannels(params?: GetLeftChannelsParams): Promise<LeftChannelList> {
    return await this.#dispatch("getLeftChannels", params);
  }
