...
export class ClientDispatcher<C extends Context = Context> extends Composer<C> implements ClientGeneric {
  ...
  async reportEphemeralMessage(chatId: ID, messageId: number, params?: ReportEphemeralMessageParams): Promise<ReportResult> {
    return await this.#dispatch("reportEphemeralMessage", chatId, messageId, params);
  }
   ...
   */
  async transferGift(chatId: ID, gift: InputGift, params?: TransferGiftParams): Promise<void> {
    return await this.#dispatch("transferGift", chatId, gift, params);
  }
  ...
  async getCommunityP(communityId: number): Promise<CommunityP> {
    return await this.#dispatch("getCommunityP", communityId);
  }
