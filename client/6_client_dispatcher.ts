...
import type { AlbumStoryList, Animation, AppSupport, Audio, AuthorizationSession, AvailableReactions, Birthday, BlockedUserList, BotAccessSettings, BotCommand, BotTokenCheckResult, BusinessAwayMessageSchedule, BusinessConnection, CallbackQueryAnswer, CallbackQueryQuestion, Chat, ChatActionType, ChatJoinResult, ChatListItem, ChatMember, ChatP, ChatPChannel, ChatPGroup, ChatPPrivate, ChatPSupergroup, ChatSettings, ClaimedGifts, CodeCheckResult, Community, ConnectedWebsite, Country, EmojiStatus, FailedInvitation, FileSource, Gift, GiftCollection, GiftPrivacy, ID, InactiveChat, InlineQueryAnswer, InlineQueryResult, InputBusinessRecipients, InputChecklistItem, InputEmojiStatus, InputGift, InputMedia, InputPollOption, InputPrivacyRule, InputRichText, InputSticker, InputStoryContent, InviteLink, JoinRequest, LeftChannelList, LinkPreview, LiveStreamChannel, Message, MessageAnimation, MessageAudio, MessageChecklist, MessageContact, MessageCounters, MessageDice, MessageDocument, MessageInvoice, MessageList, MessageLivePhoto, MessageLocation, MessagePhoto, MessagePoll, MessageReactionList, MessageRichText, MessageSticker, MessageText, MessageVenue, MessageVideo, MessageVideoNote, MessageViewer, MessageVoice, MiniAppInfo, NetworkStatistics, NewChatPrivacy, NotificationSettings, ParseMode, PasswordCheckResult, Poll, PollVoterList, PremiumSubscriptionDuration, PriceTag, PrivacyRule, PrivacySettingKey, ProfilePhotoList, Reaction, RecentActionsEntry, ReportReason, ResolvedInviteLink, RichText, SavedChats, SavedNotificationSound, SecretChat, SlowModeDuration, StarAmount, StarTransactionList, Sticker, StickerSet, StickerSetP, Story, StoryAlbum, StoryReportResult, SummarizedText, TextToTranslate, Timezone, TonTransactionList, Topic, TopicList, TopicListItem, TranslatedText, Translation, Update, User, VideoChat, VideoChatActive, VideoChatScheduled, VoiceTranscription } from "../3_types.ts";
...
import { extractTransferrableObjects } from "./0_utilities.ts";
...
export class ClientDispatcher<C extends Context = Context> extends Composer<C> implements ClientGeneric {
  ...
  async #dispatch(method: string, ...args: unknown[]) {
    ...
    try {
      this.#worker.postMessage(request, extractTransferrableObjects(args));
  ...
  async signUp(firstName: string, params?: SignUpParams): Promise<number> {
    return await this.#dispatch("signUp", firstName, params);
  }
   ...
   */
  async addMusicToProfile(fileId: string, params?: AddMusicToProfileParams): Promise<void> {
    return await this.#dispatch("addMusicToProfile", fileId, params);
  }
   ...
   */
  async addSavedNotificationSound(sound: FileSource, params?: AddSavedNotificationSoundParams): Promise<void> {
    return await this.#dispatch("addSavedNotificationSound", sound, params);
  }
  ...
  async getGiftPrivacy(): Promise<GiftPrivacy> {
    return await this.#dispatch("getGiftPrivacy");
  }
  ...
  async getProfileMusic(userId: ID, params?: GetProfileMusicParams): Promise<Audio[]> {
    return await this.#dispatch("getProfileMusic", userId, params);
  }
  ...
  async getSavedNotificationSounds(): Promise<SavedNotificationSound[]> {
    return await this.#dispatch("getSavedNotificationSounds");
  }
  ...
  async removeBusinessIntro(): Promise<void> {
    return await this.#dispatch("removeBusinessIntro");
  }
   ...
   */
  async removeMusicFromProfile(fileId: string): Promise<void> {
    return await this.#dispatch("removeMusicFromProfile", fileId);
  }
   ...
   */
  async removeSavedNotificationSound(fileId: string): Promise<void> {
    return await this.#dispatch("removeSavedNotificationSound", fileId);
  }
  ...
  async setBusinessIntro(title: string, description: string, params?: SetBusinessIntroParams): Promise<void> {
    return await this.#dispatch("setBusinessIntro", title, description, params);
  }
  ...
  async setGiftPrivacy(value: GiftPrivacy): Promise<void> {
    return await this.#dispatch("setGiftPrivacy", value);
  }
  ...
  async setNewChatPrivacy(value: NewChatPrivacy): Promise<void> {
    return await this.#dispatch("setNewChatPrivacy", value);
  }
   ...
   */
  async saveDraft(chatId: ID, text: string, params?: SaveDraftParams): Promise<void> {
    return await this.#dispatch("saveDraft", chatId, text, params);
  }
   ...
   * @param text The text of the draft.
   */
  async saveRichTextDraft(chatId: ID, richText: InputRichText, params?: SaveRichTextDraftParams): Promise<void> {
    return await this.#dispatch("saveRichTextDraft", chatId, richText, params);
  }
   ...
   */
  async sendChatAction(chatId: ID, action: ChatActionType, params?: SendChatActionParams): Promise<void> {
   ...
   */
  async boostChat(chatId: ID, params?: BoostChatParams): Promise<void> {
  ...
  /**
   * Get a chat's notification settings. User-only.
   *
   * @method ch
   * @param chatId The identifier of the chat.
   */
  async getNotificationSettings(chatId: ID): Promise<NotificationSettings> {
    return await this.#dispatch("getNotificationSettings", chatId);
  }
   ...
   * @param chatId The identifier of the chat.
   */
  async setNotificationSettings(chatId: ID, params?: SetNotificationSettingsParams): Promise<void> {
    return await this.#dispatch("setNotificationSettings", chatId, params);
  }
   ...
   * @method bo
   */
  async deleteMyCommands(params?: DeleteMyCommandsParams): Promise<void> {
    return await this.#dispatch("deleteMyCommands", params);
  }
   ...
   * @method bo
   */
  async setMyDescription(params?: SetMyDescriptionParams): Promise<void> {
   ...
   * @method bo
   */
  async setMyName(params?: SetMyNameParams): Promise<void> {
   ...
   * @method bo
   */
  async setMyShortDescription(params?: SetMyShortDescriptionParams): Promise<void> {
   ...
   *
   * @method st
   * @param chatId The identifier of the chat including the story.
   * @param storyId The identifier of the story to edit.
   * @returns The edited story.
   */
  async editStory(chatId: ID, storyId: number, params?: EditStoryParams): Promise<Story> {
    return await this.#dispatch("editStory", chatId, storyId, params);
  }
  ...
  async getStoriesInAlbum(chatId: ID, albumId: number, params?: GetStoriesInAlbumParams): Promise<AlbumStoryList> {
    return await this.#dispatch("getStoriesInAlbum", chatId, albumId, params);
  }
   ...
   *
   * @method pa
   * @param chatId The identifier of the chat to get TON transactions for.
   */
  async getTonTransactions(chatId: ID, params?: GetTonTransactionsParams): Promise<TonTransactionList> {
    return await this.#dispatch("getTonTransactions", chatId, params);
  }
  ...
  async replaceStickerEmoji(fileId: string, emoji: string): Promise<void> {
    return await this.#dispatch("replaceStickerEmoji", fileId, emoji);
  }
   ...
   */
  async setStickerSetThumbnail(slug: string, thumbnail: FileSource, params?: SetStickerSetThumbnailParams): Promise<void> {
    return await this.#dispatch("setStickerSetThumbnail", slug, thumbnail, params);
  }
  ...
  async sendSecretContact(id: number, firstName: string, phoneNumber: string, params?: SendSecretContactParams): Promise<void> {
    return await this.#dispatch("sendSecretContact", id, firstName, phoneNumber, params);
  }
  ...
  async createCommunity(name: string, chatId: ID, params?: CreateCommunityParams): Promise<Community> {
    return await this.#dispatch("createCommunity", name, chatId, params);
  }
  ...
  async deleteCommunity(communityId: number): Promise<void> {
    return await this.#dispatch("deleteCommunity", communityId);
  }
  ...
  async removeChatFromCommunity(communityId: number, chatId: ID): Promise<void> {
    return await this.#dispatch("removeChatFromCommunity", communityId, chatId);
  }
